...
- **技术指标**：偏离率 + 均偏/极偏（连续周期统计）、RSI (6/12/24)、布林带 %B（BB 10/1.5），卡片内紧凑展示；K线图模态框内可叠加 MACD/RSI/布林带
...
| 日期 | 版本 | 内容 |
|------|------|------|
| 2026-05-30 | v2.1.1 | 布林带参数优化 BB(10, 1.5)：中轨对齐 MA10，带宽适配快速周期；修复 K线图布林带初次打开不渲染 bug（checkbox 状态同步） |
